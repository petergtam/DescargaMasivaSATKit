...
public enum QueryType: String, CaseIterable, Identifiable, Codable {
...
public enum ReceiptType: String, CaseIterable, Identifiable, Codable {
  case ingreso = "I"
  case egreso = "E"
  case traslado = "T"
  case nomina = "N"
...
public enum ReceiptStatus: String, CaseIterable, Identifiable, Codable {
  case todos
  case cancelado
  case vigente
...
public enum OperationType: String, CaseIterable, Identifiable, Codable {
  case emitidas
  case recibidas
...
public enum EndPoint: String, CaseIterable, Identifiable, Codable {
  case facturas
  case retenciones
...
public struct InvoiceParams: Codable {
