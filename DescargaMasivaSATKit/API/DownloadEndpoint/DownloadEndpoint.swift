...
public struct DownloadEndpoint {
    ...
    private func createDescargaBody() throws -> String {
        ...
        let nodoSolicitud = "<des:peticionDescarga IdPaquete=\"\(packageId)\" RfcSolicitante=\"\(rfc)\"></des:peticionDescarga>"

        let digestInfo = "<des:PeticionDescargaMasivaTercerosEntrada xmlns:des=\"http://DescargaMasivaTerceros.sat.gob.mx\">\(nodoSolicitud)</des:PeticionDescargaMasivaTercerosEntrada>"
